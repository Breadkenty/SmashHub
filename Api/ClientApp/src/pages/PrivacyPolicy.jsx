...
export function PrivacyPolicy() {
  return (
    <div className="rules-and-privacy">
      <section>
        <h1>Privacy Policy</h1>
        <hr />
        <h3>Effective September 13, 2020. Last Revised September 13, 2020</h3>

        <p>
          At Smash Combos, we collect and manage user data according to the
        ...
        <p>
          ...
          timestamp for the request. We also use various technologies to collect
          information, and this may include sending cookies to your computer.
          Cookies are small data files stored on your hard drive or in your
          device memory that helps us to improve our services and your
          experience, see which areas and features of our services are popular
          and count visits. We may also collect information using web beacons
          (also known as "tracking pixels"). Web beacons are electronic images
          that may be used in our services or emails and to track count visits
          or understand usage and campaign effectiveness. Our Privacy Policy was
        ...
        <p>
          We only use your personal information to provide you the Smash
          Combos services or to communicate with you about the Website or the
          services.
        </p>
        <p>
